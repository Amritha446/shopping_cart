                ...
                <div class = "mainContent d-flex justify-content-center align-items-center h-50" id = "content">
                    ...
                    <div class="d-flex-column">
                        <div class = "categorySection d-flex">
                            ...
                            <button type="submit" class="addSubCategoryBtn ms-4 mb-3" id="addCategoryBtn" data-bs-toggle="modal" data-bs-target="##editSubContact">Add</button>
                        </div>
                                    ...
                                    <div class="modalData">
                                        <form method="post" name="form" enctype="multipart/form-data" id="createCategory">
                                            <div class="input d-flex-column">
                                                ...
                                                <button type="submit" name="editSubCategorySubmit" class="btn mt-5 ms-5"<!---  onClick = "editSubCategorySubmit(event)" ---> 
                                                    id="editSubCategorySubmit" value=""></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <cfif structKeyExists(form, "editSubCategorySubmit")>
                            <cfset obj = createObject("component","components.myCart")>
                            <cfset result = obj.addSubCategory(categoryId=categoryId,
